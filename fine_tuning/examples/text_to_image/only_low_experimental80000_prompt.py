...
model_path = ("/home/berke/fine_tuned_diffusing/diffusers/"
              "examples/text_to_image/low_light_only_low_model_lora_experimental_80000") # Your model path
...
while i < 100:
    ...
    image = pipe(prompt=prompt1, negative_prompt=negative_prompt, generator=generator,
                 num_inference_steps=75, guidance_scale=10.5).images[0]
    image.save("/home/berke/fine_tuned_diffusing/diffusers/examples"
               "/text_to_image/lora_images/only_low_img_model_experimental_80000/forest_low_exposure%s.png" % randSeed)
