...
model_path = ("/home/berke/fine_tuned_diffusing/diffusers/"
              "examples/text_to_image/low_light_only_low_model_lora_experimental") # Your model path
...
while i < 15:
    ...
    image.save("/home/berke/fine_tuned_diffusing/diffusers/examples"
               "/text_to_image/lora_images/only_low_img_model_experimental_15000/forest_low_exposure%s.png" % randSeed)
